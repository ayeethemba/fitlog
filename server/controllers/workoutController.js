...
const createWorkout = async (req, res) => {
    ...
    try {
        ...
        for (let i = 0; i < exercises.length; i++) {
            const e = await pool.query('INSERT INTO workout_exercises (workout_id, exercise_id, sets, reps, weight) VALUES ($1, $2, $3, $4, $5)', [wId, exercises[i].exercise_id, exercises[i].sets, exercises[i].reps, exercises[i].weight])
        };
